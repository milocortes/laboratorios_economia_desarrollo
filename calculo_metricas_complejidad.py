...
def _(mo):
    mo.md(r"""# Cálculo de Métricas de Complejidad""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Verificamos el ajuste con los datos del Atlas de Complejidad""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Verifica ECI""")
    return
